...
import ec.*;
import ec.app.bcdsgp.WorkflowStatTuple;
import ec.util.*;
...
public class GPIndividual extends Individual {
    ...
    public Map<String, String> workflowResps;
    ...
    public void setup(final EvolutionState state, final Parameter base) {
        ...
        this.workflowMkspns = new HashMap<>();
        this.workflowResps = new HashMap<>();
    ...
    public Map<String, Double> getWorkflowMkspns(){
        return this.workflowMkspns;
    }

    public void setWorkflowMkspns(Map<String, Double> workflowMkspns){
        this.workflowMkspns = workflowMkspns;
    }

    public Map<String, String> getWorkflowResps(){
        return this.workflowResps;
    }

    public void setWorkflowResps(Map<String, String> workflowResps){
        this.workflowResps = workflowResps;
    }
