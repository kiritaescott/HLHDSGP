...
//            System.out.println("Total number of respTasks : "+allRespTasks.size());
//            System.out.println("Mean of respTasks respsonse times : "+allRespMean);
//            state.output.println("TESTTING Total number of respTasks : "+allRespTasks.size(),log);
//            state.output.println("TESTING Mean of respTasks respsonse times : "+allRespMean,log);
//            double allRespSD = utility.getStandardDeviation(allRespTasks);
//            System.out.println("allRespTasks Standard Deviation: "+allRespSD);
//            state.output.println("TESTING allRespTasks Standard Deviation: "+allRespSD, log);
            final long finishTimeAll = System.currentTimeMillis() - startTimeAll;
            System.out.printf("Time to TEST all scenarios: %d milliseconds%n", finishTimeAll);
            state.output.println("Time to TEST all scenarios: "+ finishTimeAll +" milliseconds", log);
            double mean = utility.getAverageResponseTime(wfResponseTimes);
