...
public class Parameters {
    ...
    public enum SchedulingAlgorithm {
        ...
        MAXMIN, MINMIN, MCT, DATA, HEFT, GP, BCDSGP, GRPHEFT, GPHH,
    ...
    public static BCDSGPUtility getBCDSGPUtility() { return bcdsgpUtility; }
    ...
    public static GPHHUtility getGphhUtility() {
        return gphhUtility;
    }

    public static void setGphhUtility(GPHHUtility gphhUtility) {
        Parameters.gphhUtility = gphhUtility;
    }

    /**
     * Parameters for GPHH
     * */
    private static GPHHUtility gphhUtility;

    /**
     * Parameters for BCDSGP
     * */
    private static BCDSGPUtility bcdsgpUtility;

    /**
     * Budget of a workflow
     * */
    ...
    public static void init(
            ...
            OverheadParameters op, ClusteringParameters cp,
            SchedulingAlgorithm scheduler, PlanningAlgorithm planner, String rMethod,
            long dl, BCDSGPUtility utility, double budget) {
    ...
    /**
     * Gets the budget of a workflow
     *
     * @return the budget of a workflow
     * */
