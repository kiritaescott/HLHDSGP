...
public class WorkflowSimMultipleWorkflowsExample1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (File f : utility.getTaskFileList(0)){
    ...
    protected static void printJobList(List<Job> list) {
        ...
        Log.printLine("Cloudlet ID" + indent + "STATUS" + indent
                ...
                + "Time" + indent + "Start Time" + indent + "Finish Time" + indent + "Depth"+ indent + "Resp Time");
        ...
        for (int i = 0; i < size; i++) {
            ...
            double respTime = job.getFinishTime() - job.getAllocationTime();
            ...
            if (job.getCloudletStatus() == Cloudlet.SUCCESS) {
                ...
                Log.printLine(indent + indent + job.getResourceId() + indent + indent + indent + job.getVmId()
                        ...
                        + dft.format(job.getFinishTime()) + indent + indent + indent + job.getDepth()+ indent + indent + indent + respTime);
        ...
        double mean = getAverageResponseTime(respTimes);
        Log.printLine("OVERALL MEAN: "+mean);

    }

    public static double getAverageResponseTime(ArrayList<Double> respTimes){
        double mean = 0;
        double sum = 0;
