 ...
 * @date Jan 30, 2020
 */
public class BCDSGPSchedulingAlgorithmExample {
     ...
     * and one storage
     */
    public static List<Job> runSimulation(BCDSGPUtility gpUtility) {

        try {
            // First step: Initialize the WorkflowSim package.

            int vmNum = 0; //parameter not used
            double budget = 0; //budget constraint, may need to come from gputility
            /**
             ...
             */
            Parameters.SchedulingAlgorithm sch_method = Parameters.SchedulingAlgorithm.BCDSGP;
            ...
            List<CondorVM> vmlist0 = gpUtility.createVMS(wfEngine.getSchedulerId(0));
            /**
             * Submits this list of vms to this WorkflowEngine.
             */
            wfEngine.submitVmList(vmlist0, 0);

            WorkflowDatacenter datacenter0 = createDatacenter("Datacenter_0", vmlist0.size());
    ...
    protected static WorkflowDatacenter createDatacenter(String name, int numVMs) {
